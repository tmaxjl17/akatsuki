/* =========================================================
   ...
   ---------------------------------------------------------
   Les visuels sont partagés par les trois propositions et vivent
   dans /assets/img à la racine du projet. Ajoutez
   `img: "../assets/img/nom.png"` à un membre pour remplacer le
   cadre « placeholder » par une vraie image.
